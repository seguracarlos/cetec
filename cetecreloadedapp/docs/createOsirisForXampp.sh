#Osiris by IOFractal
#Este script crea la BD de Osiris usando el mysql de Xampp
#Para windows buscar el ejecutable y cambiar la ruta en variable OSIRISOSIRISPATH
...
LOGFILE="$DAT-bdlogXampp.log"
touch ./logs/$LOGFILE

OSIRISPATH="c:/xampp/mysql/bin/mysql"
#OSIRISPATH="/opt/lampp/bin/mysql"
...
echo $(date) + "Inicia - osiris_table_typesinister"
$OSIRISPATH -u root -proot --default-character-set=utf8 osiris < ./0_osiris/tables/osiris_table_typesinister.sql
echo $(date) + "Fin - osiris_table_typesinister"
echo $(date) + "Inicia - osiris_table_sinister"
$OSIRISPATH -u root -proot --default-character-set=utf8 osiris < ./0_osiris/tables/osiris_table_sinister.sql
echo $(date) + "Fin - osiris_table_sinister"
echo $(date) + "Inicia - osiris_table_calls_sinister"
$OSIRISPATH -u root -proot --default-character-set=utf8 osiris < ./0_osiris/tables/osiris_table_calls_sinister.sql
echo $(date) + "Fin - osiris_table_calls_sinister"
...
echo $(date) + "Inicia - osiris_table_tenencias"
$OSIRISPATH -u root -proot --default-character-set=utf8 osiris < ./0_osiris/tables/osiris_table_tenencias.sql
echo $(date) + "Fin - osiris_table_tenencias" 
echo $(date) + "Inicia - osiris_table_services_projects"
$OSIRISPATH -u root -proot --default-character-set=utf8 osiris < ./0_osiris/tables/osiris_table_services_projects.sql
echo $(date) + "Fin - osiris_table_services_projects" 
...
echo $(date) + "Inicia - osiris_data_typesinister"
$OSIRISPATH -u root -proot --default-character-set=utf8 osiris < ./0_osiris/data/osiris_data_typesinister.sql
echo $(date) + "Fin - osiris_data_typesinister"
...
echo $(date) + "Inicia - osiris_data_sinister"
$OSIRISPATH -u root -proot --default-character-set=utf8 osiris < ./0_osiris/data/osiris_data_sinister.sql
echo $(date) + "Fin - osiris_data_sinister"
echo $(date) + "Inicia - osiris_data_calls_sinister"
$OSIRISPATH -u root -proot --default-character-set=utf8 osiris < ./0_osiris/data/osiris_data_calls_sinister.sql
echo $(date) + "Fin - osiris_data_calls_sinister" 
...
echo $(date) + "Inicia - osiris_data_tenencias"
$OSIRISPATH -u root -proot --default-character-set=utf8 osiris < ./0_osiris/data/osiris_data_tenencias.sql
echo $(date) + "Fin - osiris_data_tenencias" 
echo $(date) + "Inicia - osiris_data_services_projects"
$OSIRISPATH -u root -proot --default-character-set=utf8 osiris < ./0_osiris/data/osiris_data_services_projects.sql
echo $(date) + "Fin - osiris_data_services_projects" 
