...
CREATE TABLE `cv` (
  `idcvitae` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`idcvitae`,`acl_users_id`),
  KEY `fk_c_vitae_acl_users1_idx` (`idcvitae`,`acl_users_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='CV de los colaboradores';
