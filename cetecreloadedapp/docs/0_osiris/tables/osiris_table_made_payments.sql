...
--
-- Table structure for table `made_payments`
--
...
CREATE TABLE `made_payments` (
  ...
  KEY `made_payment_to_projects` (`project_id`),
  CONSTRAINT `made_payment_to_projects` FOREIGN KEY (`project_id`) REFERENCES `projects` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE
