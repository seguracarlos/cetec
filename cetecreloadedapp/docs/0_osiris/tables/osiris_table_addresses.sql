...
CREATE TABLE `addresses` (
  ...
  CONSTRAINT `fk_company` FOREIGN KEY (`company_id`) REFERENCES `company` (`id_company`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='Direcciones de los clientes, proveedores o Host';
