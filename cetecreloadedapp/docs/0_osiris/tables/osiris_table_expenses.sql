...
CREATE TABLE `expenses` (
  ...
  KEY `fk_Expenses_acl_users1_idx` (`id_fk_user`),
  CONSTRAINT `fk_Expenses_acl_users1` FOREIGN KEY (`id_fk_user`) REFERENCES `company` (`id_company`) ON DELETE NO ACTION ON UPDATE NO ACTION
