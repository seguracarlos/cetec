...
--
-- Table structure for table `iof_user_role`
--
...
--
-- Filtros para la tabla `iof_user_role`
--
ALTER TABLE `iof_user_role`
ADD CONSTRAINT `iof_user_role_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `iof_users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD CONSTRAINT `iof_user_role_ibfk_2` FOREIGN KEY (`role_id`) REFERENCES `iof_role` (`rid`) ON DELETE CASCADE ON UPDATE CASCADE;
