...
CREATE TABLE `stock` (
  ...
  KEY `fk_stock_products1_idx` (`id_fk_products`),
  CONSTRAINT `fk_stock_products1` FOREIGN KEY (`id_fk_products`) REFERENCES `products` (`id_products`) ON DELETE CASCADE ON UPDATE CASCADE
