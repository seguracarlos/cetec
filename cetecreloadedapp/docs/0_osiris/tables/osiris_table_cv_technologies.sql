...
--
-- Table structure for table `cv_technologies`
--
...
CREATE TABLE `cv_technologies` (
  ...
  PRIMARY KEY (`id_tech`),
  KEY `fk_technologies_techtype1_idx` (`techtype_idtechtype`),
  CONSTRAINT `fk_technologies_techtype1` FOREIGN KEY (`techtype_idtechtype`) REFERENCES `techtype` (`idtechtype`) ON DELETE CASCADE ON UPDATE CASCADE
