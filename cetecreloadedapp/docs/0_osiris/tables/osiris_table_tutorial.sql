...
CREATE TABLE `tutorial` (
  ...
  KEY `fk_tutorial_tipo_tutorial1_idx` (`tipo_id`),
  CONSTRAINT `fk_tutorial_tipo_tutorial1` FOREIGN KEY (`tipo_id`) REFERENCES `tipo_tutorial` (`id_tipo`) ON DELETE CASCADE ON UPDATE CASCADE
