...
--
-- Table structure for table `price_services`
--
...
CREATE TABLE `price_services` (
  ...
  KEY `fk_price_services_order1` (`id_prospect`),
  CONSTRAINT `fk_price_services_order1` FOREIGN KEY (`id_prospect`) REFERENCES `projects` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
