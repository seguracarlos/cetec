...
CREATE TABLE `documents_fields` (
  ...
  KEY `fk_company_id_field_document_idx` (`id_document`),
  CONSTRAINT `fk_company_id_document_id_document` FOREIGN KEY (`id_document`) REFERENCES `documents` (`id_document`) ON DELETE CASCADE ON UPDATE CASCADE
