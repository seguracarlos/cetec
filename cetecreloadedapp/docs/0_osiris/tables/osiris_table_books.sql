...
CREATE TABLE `books` (
  ...
  PRIMARY KEY (`idbooks`),
  KEY `fk_books_tipo_books1_idx` (`tipo_books`),
  CONSTRAINT `fk_books_tipo_books1` FOREIGN KEY (`tipo_books`) REFERENCES `tipo_books` (`id_type`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Inventario de libros';
