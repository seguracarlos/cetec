...
use Usermanual\Model\TopicsModel;
use Usermanual\Entities\TopicsEntity;


class TopicsModelImpl extends TableGateway implements TopicsModel{
...
// 					type, id_user, content FROM topics INNER JOIN contents 
